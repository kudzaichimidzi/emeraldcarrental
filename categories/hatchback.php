...
$sql = "SELECT VehiclesTitle, Vimage1, PricePerDay, id FROM tblvehicles WHERE VehicleType='Hatchback'";
...
<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><title>Hatchback Rentals - Emerald Cars</title></head>
<body>
<div class="container hatchback-section">
  <h1>Hatchback Rentals</h1>
  <p>"Compact, efficient, and perfect for city life."</p>
  <div class="row">
    <?php foreach($results as $car) { ?>
      <div class="col-md-4">
        <div class="hatchback-card">
