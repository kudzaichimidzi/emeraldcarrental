...
$sql = "SELECT VehiclesTitle, Vimage1, PricePerDay, id FROM tblvehicles WHERE VehicleType='Convertible'";
...
<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><title>Convertible Rentals - Emerald Cars</title></head>
<body>
<div class="container convertible-section">
  <h1>Convertible Rentals</h1>
  <p>"Feel the wind, enjoy the freedom."</p>
  <div class="row">
    <?php foreach($results as $car) { ?>
      <div class="col-md-4">
        <div class="convertible-card">
