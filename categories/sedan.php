...
$sql = "SELECT VehiclesTitle, Vimage1, PricePerDay, id FROM tblvehicles WHERE VehicleType='Sedan'";
...
<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><title>Sedan Rentals - Emerald Cars</title></head>
<body>
<div class="container sedan-section">
  <h1>Sedan Rentals</h1>
  <p>"Elegance and comfort for city and highway drives."</p>
  <div class="row">
